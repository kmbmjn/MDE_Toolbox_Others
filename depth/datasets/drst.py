...
class DRSTDataset(Dataset):
    ...
    def eval_kb_crop(self, depth_gt):
        ...
        ### top_margin = int(height - 1216)
        ### top_margin = int(height - 2048)
        top_margin = int(height - 384)
        ### left_margin = int((width - 1216) / 2)
        ### left_margin = int((width - 1920) / 2)
        ### left_margin = int((width - 2464) / 2)
        left_margin = int((width - 864) / 2)
        ### depth_cropped = depth_gt[top_margin: top_margin + 352, left_margin: left_margin + 1216]
        ### depth_cropped = depth_gt[top_margin: top_margin + 1216, left_margin: left_margin + 1920]
        ### depth_cropped = depth_gt[top_margin: top_margin + 2056, left_margin: left_margin + 2464]
        depth_cropped = depth_gt[top_margin: top_margin + 384, left_margin: left_margin + 864]
