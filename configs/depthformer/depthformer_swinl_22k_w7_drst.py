_base_ = [
    ...
    ### '../_base_/models/depthformer_swin.py', '../_base_/datasets/ddad.py',
    ### '../_base_/models/depthformer_swin.py', '../_base_/datasets/argo.py',
    '../_base_/models/depthformer_swin.py', '../_base_/datasets/drst.py',
